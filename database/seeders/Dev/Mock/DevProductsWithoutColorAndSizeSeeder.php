...
class DevProductsWithoutColorAndSizeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        for ($i=0; $i<10; $i++) {
            ...
            Product::create([
                'code' => $this->getCodeWithoutSizeAndColor(),
    ...
    private function getCodeWithoutSizeAndColor(): string
    {
        // KOD TOWARU: MODEL.GRUPA_ROZMIAROWA.ROZMIAR.00.00.PRODUCENT
        $code = "";
