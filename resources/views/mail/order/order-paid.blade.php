...
@section('title', __('Zamówienie opłacone', ['order_id' => $order->id]))
...
@section('body')
    ...
    <div>
        ...
        <p>{{ __('Zamówienie nr :order_id zostało opłacone', ['order_id' => $order->id]) }}.</p>
        ...
        <div class="mt-4 flex gap-2 justify-start items-center">
            <x-button primary href='{{ $order->tracking_url }}'>
                {{ __('Link do przesyłki') }}
            </x-button>
