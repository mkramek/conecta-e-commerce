<div class="max-w-screen-lg mx-auto">
    ...
    <p class="max-w-screen-md py-6 text-xl">{{ __('Na Twój adres email zostało wysłane potwierdzenie. Zamówienie zostało przekazane do wybranego przez Ciebie kuriera.') }}</p>
    <div>
