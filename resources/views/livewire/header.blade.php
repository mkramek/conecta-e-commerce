<header class="w-full bg-zinc-600 z-10 sticky top-0 left-0 right-0">
    <div
        ...
        <div
            class="basis-full lg:basis-1/4 flex items-center justify-center lg:justify-start">
            <img src="/img/svg/Con_krzywe_bez_Srodkow.svg" alt="Logo - Conecta"
                 class="h-12 m-2 lg:m-0"/>
        </div>
        <div
            class="basis-full lg:basis-1/2 lg:block {{ $menu ? '' : 'hidden' }}">
            <nav
        ...
        <div
            ...
            <a class="{{ request()->path() === "$lang/profile" ? "border-b-[3px] border-b-primary-600 rounded-md" : "" }}"
               href="{{ auth()->id() ? route("profile.$lang") : route("login.$lang") }}">
