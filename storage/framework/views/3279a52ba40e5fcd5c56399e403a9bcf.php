<div id="homeCarousel" class="relative max-h-[60vh]" data-twe-carousel-init data-twe-ride="carousel">
    ...
    <div class="absolute bottom-0 left-0 right-0 z-[2] mx-[15%] mb-4 flex list-none justify-center p-0"
        ...
        <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < count($images); $i++): ?>
            <button type="button" data-twe-target="#homeCarousel" data-twe-slide-to="<?php echo e($i); ?>"
                <?php if($i === 0): ?> data-twe-carousel-active <?php endif; ?>
                ...
                aria-current="true" aria-label="Slajd <?php echo e($i + 1); ?>"></button>
    ...
    <div class="relative w-full overflow-hidden after:clear-both after:block after:content-[''] max-h-[60vh]">
        ...
        <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < count($images); $i++): ?>
            <div class="relative float-left -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
                <?php if($i === 0): ?> data-twe-carousel-active <?php endif; ?> data-twe-carousel-item
                data-twe-carousel-fade style="backface-visibility: hidden">
                <img src="<?php echo e($images[$i]->url); ?>" class="block w-full" alt="Obraz nagłówka" />
            </div>
        <?php endfor; ?><!--[if ENDBLOCK]><![endif]-->
    </div>
...
<?php /**PATH /var/app/ecommerce/resources/views/livewire/carousel.blade.php ENDPATH**/ ?>